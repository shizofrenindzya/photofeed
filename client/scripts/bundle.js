...
__vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_c('div',{staticClass:"view"},[_c('router-view')],1)])}
__vue__options__.staticRenderFns = []
__vue__options__._scopeId = "data-v-47599d1a"
if (module.hot) {(function () {  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-47599d1a", __vue__options__)
  } else {
    hotAPI.reload("data-v-47599d1a", __vue__options__)
  }
})()}
...
var __vue__options__ = (typeof module.exports === "function"? module.exports.options: module.exports)
if (__vue__options__.functional) {console.error("[vueify] functional components are not supported and should be defined in plain js files using render functions.")}
__vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('nav-penal')}
__vue__options__.staticRenderFns = []
if (module.hot) {(function () {  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-5fa7433c", __vue__options__)
  } else {
    hotAPI.reload("data-v-5fa7433c", __vue__options__)
  }
})()}
},{"./navigation.vue":8,"vue":21,"vue-hot-reload-api":16}],6:[function(require,module,exports){
;(function(){
//
//
//
...
if (module.hot) {(function () {  var hotAPI = require("vue-hot-reload-api")
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-6c8c8db8", __vue__options__)
  } else {
    hotAPI.reload("data-v-6c8c8db8", __vue__options__)
  }
})()}
},{"vue":21,"vue-hot-reload-api":16}],7:[function(require,module,exports){
var __vueify_style_dispose__ = require("vueify/lib/insert-css").insert("\n#register[data-v-41991de5] {\n    width: 50%;\n    min-width: 300px;\n    max-width: 675px;\n    height: auto;\n    display:block;\n    position: absolute;\n    left: 50%;\n    top: 50%;\n    transform: translate(-50%, -50%);\n}\ninput[data-v-41991de5], button[data-v-41991de5] {\n    font-size: 1.1rem;\n    width: 100%;\n    margin: 7px 0px;\n    padding: 10px 20px;\n    border-radius: 5px;\n    outline: none;\n}\ninput[data-v-41991de5] {\n    border: 1px solid black;\n}\nbutton[data-v-41991de5] {\n    color: white;\n    background-color: rgb(69, 69, 190);\n    border:none;\n}\nbutton[data-v-41991de5]:hover {\n background-color: cornflowerblue;   \n}\n#link[data-v-41991de5] {\n    display: block;\n    color: rgb(69, 69, 190);\n    text-align: center;\n    text-decoration: none;\n    font-family: sans-serif;\n}")
;(function(){
//
//
//
...
var __vue__options__ = (typeof module.exports === "function"? module.exports.options: module.exports)
if (__vue__options__.functional) {console.error("[vueify] functional components are not supported and should be defined in plain js files using render functions.")}
__vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('form',{attrs:{"id":"register","method":"POST"}},[_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.username),expression:"username"}],attrs:{"type":"text","placeholder":"Логин"},domProps:{"value":(_vm.username)},on:{"input":function($event){if($event.target.composing){ return; }_vm.username=$event.target.value}}}),_vm._v(" "),_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.password),expression:"password"}],attrs:{"type":"password","placeholder":"Пароль"},domProps:{"value":(_vm.password)},on:{"input":function($event){if($event.target.composing){ return; }_vm.password=$event.target.value}}}),_vm._v(" "),_c('button',{attrs:{"type":"submit"},on:{"click":_vm.initialisation}},[_vm._v("Войти")]),_vm._v(" "),_c('router-link',{attrs:{"id":"link","to":"/register"}},[_vm._v("Регистрация")])],1)}
__vue__options__.staticRenderFns = []
__vue__options__._scopeId = "data-v-41991de5"
if (module.hot) {(function () {  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-41991de5", __vue__options__)
  } else {
    hotAPI.reload("data-v-41991de5", __vue__options__)
  }
})()}
},{"vue":21,"vue-hot-reload-api":16,"vueify/lib/insert-css":23}],8:[function(require,module,exports){
var __vueify_style_dispose__ = require("vueify/lib/insert-css").insert("#header[data-v-cfefbf9c] {\r\n    display: flex;\r\n    justify-content: space-between;\r\n}\r\n#button[data-v-cfefbf9c] {\r\n    padding: 15px;\r\n    background-color: white;\r\n    color: black;\r\n    border: solid black;\r\n    font-size: 20px;\r\n}\r\na[data-v-cfefbf9c] {\r\n    padding: 15px;\r\n    color: black;\r\n    font-size: 20px;\r\n    text-decoration: none;\r\n    border: solid black;\r\n}\r\na[data-v-cfefbf9c]:hover {\r\n    padding: 15px;\r\n    color: gray;\r\n    font-size: 20px;\r\n    text-decoration: none;\r\n    border: solid gray;\r\n}\r\n#button[data-v-cfefbf9c]:hover{\r\n    padding: 15px;\r\n    background-color: white;\r\n    color: gray;\r\n    border: solid gray;\r\n    font-size: 20px;\r\n}\r\n#feed[data-v-cfefbf9c] {\r\npadding: 10px;    \r\n}")
;(function(){
//
//
//
...
var __vue__options__ = (typeof module.exports === "function"? module.exports.options: module.exports)
if (__vue__options__.functional) {console.error("[vueify] functional components are not supported and should be defined in plain js files using render functions.")}
__vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{attrs:{"id":"header"}},[_c('div',{attrs:{"id":"feed"}},[_c('router-link',{attrs:{"to":"/"}},[_vm._v("Фотолента")])],1),_vm._v(" "),_c('div',[_c('router-link',{attrs:{"to":"/upload"}},[_vm._v("Опубликовать фото")]),_vm._v(" "),_c('button',{attrs:{"type":"submit","id":"button"},on:{"click":_vm.logOut}},[_vm._v("Выйти")])],1)])}
__vue__options__.staticRenderFns = []
__vue__options__._scopeId = "data-v-cfefbf9c"
if (module.hot) {(function () {  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  module.hot.accept()
  module.hot.dispose(__vueify_style_dispose__)
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-cfefbf9c", __vue__options__)
  } else {
    hotAPI.reload("data-v-cfefbf9c", __vue__options__)
  }
})()}
},{"vue":21,"vue-hot-reload-api":16,"vueify/lib/insert-css":23}],9:[function(require,module,exports){
var __vueify_style_dispose__ = require("vueify/lib/insert-css").insert("\n#register[data-v-e585e27e] {\n    width: 50%;\n    min-width: 300px;\n    height: auto;\n    display:block;\n    position: absolute;\n    left: 50%;\n    top: 50%;\n    transform: translate(-50%, -50%);\n}\ninput[data-v-e585e27e], button[data-v-e585e27e] {\n    font-size: 1.1rem;\n    width: 100%;\n    margin: 7px 0px;\n    padding: 10px 20px;\n    border-radius: 5px;\n    outline: none;\n}\ninput[data-v-e585e27e] {\n    border: 1px solid black;\n}\nbutton[data-v-e585e27e] {\n    color: white;\n    background-color: red;\n    border:none;\n}")
;(function(){
//
//
//
...
var __vue__options__ = (typeof module.exports === "function"? module.exports.options: module.exports)
if (__vue__options__.functional) {console.error("[vueify] functional components are not supported and should be defined in plain js files using render functions.")}
__vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('form',{attrs:{"id":"register","method":"POST"}},[_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.username),expression:"username"}],attrs:{"type":"text","placeholder":"Логин"},domProps:{"value":(_vm.username)},on:{"input":function($event){if($event.target.composing){ return; }_vm.username=$event.target.value}}}),_vm._v(" "),_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.password),expression:"password"}],attrs:{"type":"password","placeholder":"Пароль"},domProps:{"value":(_vm.password)},on:{"input":function($event){if($event.target.composing){ return; }_vm.password=$event.target.value}}}),_vm._v(" "),_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.passwordRep),expression:"passwordRep"}],attrs:{"type":"password","placeholder":"Повторите пароль"},domProps:{"value":(_vm.passwordRep)},on:{"input":function($event){if($event.target.composing){ return; }_vm.passwordRep=$event.target.value}}}),_vm._v(" "),_c('button',{attrs:{"type":"submit"},on:{"click":_vm.register}},[_vm._v("Зарегистироваться")])])}
__vue__options__.staticRenderFns = []
__vue__options__._scopeId = "data-v-e585e27e"
if (module.hot) {(function () {  var hotAPI = require("vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  module.hot.accept()
  module.hot.dispose(__vueify_style_dispose__)
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-e585e27e", __vue__options__)
  } else {
    hotAPI.reload("data-v-e585e27e", __vue__options__)
  }
})()}
...
},{"../components/app.vue":4,"../components/feed.vue":5,"../components/index.vue":6,"../components/initialisation.vue":7,"../components/register.vue":9,"../components/upload.vue":10,"vue":21,"vue-jwt-mongo":17,"vue-resource":18,"vue-router":19}],12:[function(require,module,exports){
/**
